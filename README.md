...
На втором компьютере удобнее сначала подключить Google Диск и нажать «Скачать
хранилища», а потом входить. Если сделать наоборот, ничего страшного не
случится: приложение увидит, что вашим паролем открываются два хранилища, и
объединит их при входе. Все записи окажутся в одном списке.
